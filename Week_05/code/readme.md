...
2、starter
https://blog.csdn.net/w1014074794/article/details/88539284
...
https://bugstack.cn/itstack-demo-agent/2019/07/15/%E5%9F%BA%E4%BA%8EJavaAgent%E7%9A%84%E5%85%A8%E9%93%BE%E8%B7%AF%E7%9B%91%E6%8E%A7%E5%85%AD-%E5%BC%80%E5%8F%91%E5%BA%94%E7%94%A8%E7%BA%A7%E7%9B%91%E6%8E%A7.html
创建Agent，创建intercept，
 * mvn 配置plugin
 * mvn clean package
 * 配置MANIFEST.MF
 ...
 */
使用场景3：AOP切面
https://blog.51cto.com/shadowisper/2468593?source=dra
https://blog.csdn.net/generalfu/article/details/106130262?utm_medium=distribute.pc_relevant.none-task-blog-utm_term-2&spm=1001.2101.3001.4242
https://blog.csdn.net/wanxiaoderen/article/details/106544773?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522160523766319724836752373%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fall.%2522%257D&request_id=160523766319724836752373&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~first_rank_v2~rank_v28-2-106544773.pc_first_rank_v2_rank_v28&utm_term=bytebuddy&spm=1018.2118.3001.4449
https://blog.csdn.net/u013212754/article/details/103138600
//        UserServiceV2 service = new ByteBuddy()
//                .subclass(UserServiceV2.class)
//                .method(ElementMatchers.any())
//                .intercept(Advice.to(UserInterceptV2.class))
//                .make()
//                .load(UserServiceV2.class.getClassLoader())
//                .getLoaded()
//                .newInstance();
//        service.printA();
//        service.printA();

通过instrument可以实现一个Agent来修改类的字节码。下面我们会借助javassist实现一个简单的性能检测工具。目的是检测函数的调用耗时，这里仅仅抛砖引玉，instrument提供的更松耦合的AOP不止于此。
...
在上面-javaagent参数中提到了参阅 java.lang.instrument，这是在rt.jar 中定义的一个包，该路径下有两个重要的类：
